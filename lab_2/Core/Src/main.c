...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  xTaskCreate(TaskMonitor_App, "Monitor", 256, NULL, 1, NULL);
  xTaskCreate(Red_LED_App, "Red_LED", 128, NULL, 2, NULL);
  xTaskCreate(Green_LED_App, "Green", 128, NULL, 3, NULL);
  xTaskCreate(Delay_App, "Delay", 128, NULL, 4, NULL);
  /* USER CODE END 2 */
